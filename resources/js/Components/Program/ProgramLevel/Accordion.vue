<template>
    <AccordionContainer>
        ...
        >
            <Content :inst="inst" @handleEvidence="getDocument" :active="(storeProgLvl.selected == inst.id)" />
            ...
            <div class="w-fit h-fit shrink-0 flex gap-2 items-center ml-1">
                ...
                <AttachButton 
                    ...
                    @click="storeDocument.evidenceToAttach($page.props.currentlvl.accredId, inst)"
                />
                <DownButton 
                    title="Show more"
